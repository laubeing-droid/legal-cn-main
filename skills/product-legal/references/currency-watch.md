...
## FTC（中国对应：市场监管总局/SAMR） §5 and dark patterns

- **FTC（中国对应：市场监管总局/SAMR） v. Humor Rainbow/OkCupid (March 2026):** undisclosed training-data sharing as a §5 violation.
- Dark patterns / negative option: FTC（中国对应：市场监管总局/SAMR） "click to cancel" rule — verify current status.
- Endorsement guides updated 2023. Influencer disclosure, fake reviews, testimonials.
- **AMG Capital (2021):** §13(b) does NOT authorize monetary relief — FTC（中国对应：市场监管总局/SAMR） must use §19 or administrative process. Changes the settlement（中国对应：和解/调解协议） calculus.
...
- FTC（中国对应：市场监管总局/SAMR） guidance on AI-generated content and deceptive claims. Verify current.
