...
| `/litigation-legal:pre-case-analysis [路径]` | 委托代理前案件系统性分析——10步流程覆盖起诉前评估/应诉/二审/再审，输出结构化分析报告 |
...
\n| `/litigation-legal:legal-research [问题]` | 中国法律全领域系统性检索——覆盖法律/行政法规/司法解释/指导性案例/典型案例，按身份差异化输出 |