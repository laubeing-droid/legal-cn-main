...
**已安装技能的质量评估相关法域检查。**社区技能通常主张美国工作成果头（`PRIVILEGED & CONFIDENTIAL — ATTORNEY WORK-PRODUCT（律师工作成果；中国仅《律师法》第38条保密义务） — PREPARED AT THE DIRECTION OF COUNSEL`）。"Attorney WORK-PRODUCT（律师工作成果；中国仅《律师法》第38条保密义务）" 是美国法学说（FRCP（中国对应：《中华人民共和国民事诉讼法》及最高院司法解释；中国无FRCP体系） 26(b)(3)），在大多数其他法律体系中不存在 — 在文件上主张它并不能创造它。进行质量评估时，标记任何主张美国 WORK-PRODUCT（律师工作成果；中国仅《律师法》第38条保密义务） 保护但无法域条件说明的头 — 虚假的保护确信比不标注更糟糕。建议技能添加法域分支，保留 `PRIVILEGED & CONFIDENTIAL`（在各处有意义），并在实践画像为非美国法域时代替使用 `CONFIDENTIAL — INTERNAL LEGAL ANALYSIS — NOT A SUBSTITUTE FOR EXTERNAL COUNSEL ADVICE`。

**对于使用中国法的实践者：** 中国法律体系下，《律师法》第 38 条和《律师执业管理办法》规定了律师保密义务。社区技能不应简单套用美国 WORK-PRODUCT（律师工作成果；中国仅《律师法》第38条保密义务） 概念，而应依据中国法的保密框架进行标记。
