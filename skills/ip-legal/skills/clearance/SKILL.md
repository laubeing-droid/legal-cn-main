...
加载本段当且仅当法域为中国大陆。如需完整法规库，参见 ~/.claude/plugins/config/claude-for-legal/ip-legal/references/。

### 绝对驳回理由审查

#### 商标法第10条（禁用标志——不得注册且不得使用）
- [ ] 同国家名称、国旗、国徽、军旗、军徽等相同或近似
- [ ] 同中央国家机关名称、标志、所在地名称相同
- [ ] 同"红十字""红新月"名称、标志相同或近似
- [ ] 带有民族歧视性
- [ ] 带有欺骗性，使公众对商品质量/产地产生误认
- [ ] 有害于社会主义道德风尚或有其他不良影响
- [ ] 县级以上行政区划地名或公众知晓的外国地名（有第二含义的除外）

#### 商标法第11条（缺乏显著性——不得注册但可使用）
- [ ] 仅有本商品通用名称、图形、型号
...
- [ ] 在先商标冲突（商标法第30条）：相同/近似商标+相同/类似商品
- [ ] 在先权利保护（商标法第32条）：在先使用并有一定影响的商标
- [ ] 代理/代表关系抢注（商标法第15条）
- [ ] 驰名商标跨类保护（商标法第13条）
...
以下章节为面向中国境内商标注册的全面分析框架，补充本技能基础工作流中第57条混淆分析之外的完整中国商标法律体系。

### 一、绝对理由审查（《商标法》第10-12条）

依据《中华人民共和国商标法》，下列标志不得作为商标使用或注册：
...
#### 1.2 显著性审查（第9条 + 第11条）
- **第9条**：申请注册的商标，应当有显著特征，便于识别。
- **第11条**：仅有本商品的通用名称、图形、型号的；仅直接表示商品的质量、主要原料、功能、用途、重量、数量及其他特点的；其他缺乏显著特征的——不得作为商标注册。
- **例外**：前款所列标志经过使用取得显著特征并便于识别的，可以作为商标注册。

#### 1.3 三维标志功能性（第12条）
仅由商品自身的性质产生的形状、为获得技术效果而需有的形状、使商品具有实质性价值的形状——不得作为三维标志商标注册。

### 二、相对理由审查（在先权利冲突，《商标法》第30-32条）

#### 2.1 相同/近似商标（第30条）
申请注册的商标同他人在同一种商品或者类似商品上已经注册的或者初步审定的商标相同或者近似的，由商标局驳回申请。

**近似判断因素**（依据商标审查审理指南）：
- 商标构成要素的近似程度（文字、图形、字母、数字、三维标志、颜色组合、声音）
- 商品/服务的类似程度（《类似商品和服务区分表》参照）
- 相关公众的一般注意力
- 引证商标的显著性和知名度
...
#### 2.3 驰名商标保护（第13条）
- 第13条第2款：就相同或者类似商品申请注册的商标是复制、模仿或者翻译他人未在中国注册的驰名商标，容易导致混淆的，不予注册并禁止使用。
- 第13条第3款：就不相同或者不相类似商品申请注册的商标是复制、模仿或者翻译他人已经在中国注册的驰名商标，误导公众，致使该驰名商标注册人的利益可能受到损害的，不予注册并禁止使用（跨类保护）。
...
依据《商标法》第4条（2019年修正新增）：**不以使用为目的的恶意商标注册申请，应当予以驳回。**

审查要点：
- 申请数量是否远超正常经营需要
- 是否在多个类别上大量申请与他人知名商标相同或近似的商标
- 是否存在转让牟利行为
- 申请主体过去的商标申请记录和异议/无效记录
...
#### 4.2 申请形式
- 组合商标（文字+图形）建议拆分申请：文字单独申请 + 图形单独申请，提高各要素的独立保护强度
- 中英文分别注册
- 若计划出口，同步考虑马德里国际注册或单一国家注册

#### 4.3 撤三风险防范（第49条）
商标注册后若**连续三年不使用**，任何单位或个人可申请撤销。建议对核心商标建立使用证据留存机制（销售合同、发票、广告、展会照片、产品包装）。

#### 4.4 在先使用保护（第59条第3款）
若发现他人在先使用相同/近似商标，即使其未注册，也可能限制我方商标的使用范围（限于原使用范围+原商品）。注册商标专用权人无权禁止在先使用人在原使用范围内继续使用。
...
|:---|:---|:---|
| 禁用标志（第10条） | □ 通过 □ 不通过 | |
| 显著性（第11条） | □ 具备 □ 可通过使用获得 □ 不可克服 | |
| 功能性（第12条） | □ 不适用 □ 通过 □ 不通过 | |

## 三、相对理由审查（在先冲突，《商标法》第30条）
...
## 七、风险提示
> **本报告为初步检索，非商标清除法律意见。** 最终注册决策须经具备商标代理资质的专业人员复核。
```